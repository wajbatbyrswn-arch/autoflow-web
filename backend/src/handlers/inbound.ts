...
⚠️ قاعدة صارمة: لا تستخدم أي معلومات من رسائل أو طلبات سابقة (حتى لو ظهرت في سياق المحادثة). يجب أن يكتب العميل كل بياناته من جديد في هذا الطلب. اسأل عن كل معلومة بشكل صريح حتى لو أعطاها من قبل.
