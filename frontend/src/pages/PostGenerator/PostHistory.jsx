  ...
  return (
    <div className="pg-history animate-fade">
      <div className="page-header flex justify-between items-center">
        <div>
          <h1>سجل البوستات السابقة</h1>
          <p>تصفح البوستات التي قمت بتوليدها مسبقاً</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="empty-state card">
          ...
          <p>لا يوجد بوستات مولّدة حتى الآن.</p>
          <button className="btn btn-primary" onClick={() => navigate('/post-generator/create')}>توليد أول بوست</button>
        </div>
      ) : (
            ...
            <div key={post.id} className="card pg-history-item p-0 overflow-hidden relative">
              ...
              <div className="pg-history-details">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-xs text-muted">{new Date(post.created_at).toLocaleDateString('ar-SA')}</span>
                </div>
