...
const FEATURES = [
  ...
  { i: '⚠️', t: 'إدارة الشكاوى', d: 'الـ AI يكتشف الشكاوى تلقائياً، يوقف الرد، ويُبلّغك فوراً على تلغرام للتدخل البشري.' },
...
const FAQ = [
  ...
  { q: 'كم سعر الاشتراك؟', a: 'الخطة الشهرية 40 دينار أردني، تشمل كل المميزات بدون قيود.' },
